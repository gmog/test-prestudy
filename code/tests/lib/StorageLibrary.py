...
def read_storage_points(self):
    ...
    for point in points:
        print("ID:" + str(point.storageId) + " Name: " + point.name + " Desc:" + str(point.description)+ " Value:" + str(point.value))
        # raise AssertionError("write read failed")
...
if __name__ == "__main__":
    app = StorageLibrary()
    app.client.ping()
    print("value: " + str(app.read_storage_point_value(0)))
    print("verify_read_write: " + str(app.verify_write_and_read(5, "5000")))
